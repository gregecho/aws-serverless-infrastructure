...
# 2. 上传到 S3
aws s3 cp index.html s3://your-bucket-name/docs/index.html

# 3. 访问
# http://your-bucket-name.s3-website-us-east-1.amazonaws.com/docs/index.html


加到 serverless.ts 自动部署
...
// package.json
"docs:deploy": "pnpm docs:build && aws s3 cp index.html s3://${SERVICE}-docs-${STAGE}/index.html",
"docs:deploy:dev": "SERVICE=aws-serverless-infrastructure STAGE=dev pnpm docs:deploy",
"docs:url": "aws s3api get-bucket-website --bucket aws-serverless-infrastructure-docs-dev"
...
推荐
POC 阶段用 S3 静态网站最简单，不需要额外服务，部署一行命令搞定：

pnpm docs:deploy:dev
# 访问 http://aws-serverless-infrastructure-docs-dev.s3-website-us-east-1.amazonaws.com
